-- Ensure staff password login returns a session_token for secure clearance scoping.
-- Run this if Clearance says "Staff login session expired" after enabling scoped clearance.
