...
(function (w) {
  ...
  async function listSchoolAssessmentMonitor(filters) {
    ...
    throw new Error('Run the latest school assessment monitor SQL in Supabase, then refresh this page.');
  }
  ...
  async function listDocumentOwners(filters) {
    ...
    throw new Error('Run the Document Manager filter-first SQL in Supabase, then refresh this page.');
  }
